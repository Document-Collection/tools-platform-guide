...
安装完组件后，就可以进行C++编程了，最重要的是它能够提供智能提示功能，让你快速编程
...
2. 如果想要使用VSCode构建命令Tasks: Run Build Task (Ctrl+Shift+B)或Tasks: Run Build Task，那么还需要加入属性"group"，属性”group“的作用是定义该任务属于哪个组，有"build"和"test"两种，功能上没有区别
